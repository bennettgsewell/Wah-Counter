...
[
    ...
    "The borrow checker can't stop this {0} streak!",
    "Pure, unadulterated WAH: {0}!",
    "The spirit of the red panda is strong in this {0} line!",
    "Ailurus-Rust is running at high efficiency: {0}!",
    "We've reached {0}! Don't let the text-posters win!",
    ...
    "The high score is now {0}. Don't blink!",
    "Someone call a scientist, this {0} line is evolving!",
    ...
    "The Firefox is multiplying! {0} found!",
